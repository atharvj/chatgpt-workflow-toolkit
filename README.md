...
- **Return to where I was:** click ChatGPT’s floating down arrow or ↓ beside the gear to jump instantly to the latest message, then ↩ to return. Supports the arrow’s animated-dot state too; unrecognized variants are left alone.
