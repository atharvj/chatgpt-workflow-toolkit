...
test('app smoke: installs a single whole-chat, auto-send side-question flow', async () => {
  ...
  assert.match(questionDialog.querySelector('p').textContent, /branch the whole conversation so far/iu);
  assert.match(questionDialog.querySelector('p').textContent, /keep reading the original/iu);
